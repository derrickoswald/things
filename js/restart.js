    ...
    function (configuration)
    {
        ...
        function wait_for_couch (options)
        {
            ...
            xmlhttp.ontimeout = function () // whenever the request times out
            {
                ...
                if (0 < options.count)
                    setTimeout (function () { wait_for_couch (options); }, 1000);
                else
                    if (options.error)
                        options.error ();
            };
            ...
            xmlhttp.send (); // ToDo: silence the console error log... net::ERR_CONNECTION_REFUSED
        }
        ...
        function inject (options)
        {
            ...
            document.getElementById ("restart").addEventListener ("click", restart.bind (options));
            $ (modal).modal ();
        }
